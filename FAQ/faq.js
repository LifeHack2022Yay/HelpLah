document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        const data = {
            ...
            outputIndicator: '',
            inputs: [query],
            examples: [{"text": "What should I do to seem more attractive to the welfare organisations?", "label": "Volunteer"}, {"text": "What is a volunteer?", "label": "Volunteer"}, {"text": "Is there an age limit for volunteering?", "label": "Volunteer"}, {"text": "I\'m interested in volunteering. How do I apply?", "label": "Volunteer"}, {"text": "What do I need to do to be a volunteer?", "label": "Volunteer"}, {"text": "Is it free to upload openings on this website?", "label": "Organisation"}, {"text": "What information do I need when I create an opening?", "label": "Organisation"}, {"text": "How does this website benefit me?", "label": "Organisation"}, {"text": "How do I make sure that those who applied fit the role?", "label": "Organisation"}, {"text": "Is there a limit on the number of openings I can post?", "label": "Organisation"}, {"text": "How do I create an account?", "label": "Website"}, {"text": "Can I trust this website?", "label": "Website"}, {"text": "Where can I donate?", "label": "Website"}, {"text": "Is this website free?", "label": "Website"}, {"text": "How does this FAQ work?", "label": "Website"}, {"text": "Why should I volunteer?", "label": "Volunteer"}, {"text": "What is the commitment level?", "label": "Volunteer"}, {"text": "What should I do if I fall sick before the start of volunteering?", "label": "Volunteer"}]
        };
